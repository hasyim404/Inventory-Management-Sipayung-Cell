...
const Ukuran = () => {
  ...
  const handleEdit = async (e) => {
    ...
    formData.append("n_ukuran", currentItem.n_ukuran);
  ...
  const addUkuran = async (e) => {
    ...
    try {
      ...
      console.log(error);
      Swal.fire({
        title: "Gagal tambah data ukuran!",
        text: `Gagal karena ${error.response.data.message}`,
        icon: "error",
      }).then(() => {
        window.location.reload();
    ...
    <>
      ...
      <div className="w-full pt-10 px-4 sm:px-6 md:px-8 lg:ps-72">
        ...
        <p className="mb-2 text-md font-normal text-color-4">
          ...
          <span className="xt-color-5 italic"> Ukuran</span>
        </p>
              ...
              <div className="p-4 md:p-5">
                <div className="grid grid-flow-col gap-4 place-content-between">
                  <div className="col-span-3">
                    <MainTitle size="text-xl" main="Daftar Ukuran" />
                    <Subnav
                      subnav="Berisi daftar seluruh ukuran yang bisa digunakan untuk dipakai berulang kali"
                      color="text-color-4"
                    />
                  </div>
                                    ...
                                    <tr key={item.id}>
                                      ...
                                      <td className="px-6 py-4 whitespace-nowrap text-center text-sm text-color-5">
                                        <div className="text-center ">
                                          {/* <Link
                                        to={`/kelola-produk/ukuran/edit/${item.id}`}
                                      > */}
                                          <button
